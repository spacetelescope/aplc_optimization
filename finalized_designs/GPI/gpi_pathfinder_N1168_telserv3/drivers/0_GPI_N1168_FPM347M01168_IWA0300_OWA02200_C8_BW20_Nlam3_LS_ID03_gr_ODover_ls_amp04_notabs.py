parameters = {'instrument': {'inst_name': 'GPI'}, 'pupil': {'filename': 'GPI/Primary_GPI_grey_oversamp04_symmetric_N1168.fits', 'N': 1168}, 'focal_plane_mask': {'radius': 3.476449131, 'num_pix': 1168, 'grayscale': True, 'field_stop_radius': -1.0}, 'lyot_stop': {'filename': 'GPI/LS_GPI_080m12_03_grey_oversamp04_notabs_N1168.fits', 'alignment_tolerance': 0, 'num_lyot_stops': 1}, 'image': {'contrast': 8, 'iwa': 3, 'owa': 22, 'num_wavelengths': 3, 'bandwidth': 0.2, 'resolution': 2}, 'method': {'force_no_x_mirror_symmetry': False, 'force_no_y_mirror_symmetry': False, 'force_no_hermitian_symmetry': False, 'starting_scale': 4, 'ending_scale': 1, 'edge_width_for_prior': 2, 'num_throughput_iterations': 2, 'initial_throughput_estimate': 1, 'maximize_planet_throughput': True}, 'solver': {'num_threads': 0, 'crossover': 0, 'method': 2}}
file_organization = {'survey_dir': '/user/bnickson/aplc-optimization/surveys/gpi_pathfinder_N1168_telserv3', 'solution_dir': '/user/bnickson/aplc-optimization/surveys/gpi_pathfinder_N1168_telserv3/solutions', 'analysis_dir': '/user/bnickson/aplc-optimization/surveys/gpi_pathfinder_N1168_telserv3/analysis', 'drivers_dir': '/user/bnickson/aplc-optimization/surveys/gpi_pathfinder_N1168_telserv3/drivers', 'log_dir': '/user/bnickson/aplc-optimization/surveys/gpi_pathfinder_N1168_telserv3/logs', 'input_files_dir': '/user/bnickson/aplc-optimization/masks'}
solution_fname = "/user/bnickson/aplc-optimization/surveys/gpi_pathfinder_N1168_telserv3/solutions/0_GPI_N1168_FPM347M01168_IWA0300_OWA02200_C8_BW20_Nlam3_LS_ID03_gr_ODover_ls_amp04_notabs.fits"
...
apodizer = optimize_aplc(
             ...
             ß            ending_scale=method_ending_scale,
