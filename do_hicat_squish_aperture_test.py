...
survey_parameters = {'pupil': {'N': n,'filename': pup_filename}, \
                     'lyot_stop': {'filename': ls_filenames,'alignment_tolerance': 0, 'num_lyot_stops': 1}, \
...
luvoir = DesignParameterSurvey(PorAPLC, survey_parameters, 'surveys/hicat_squish_aperture/'.format(n), 'masks/')
luvoir.describe()
