...
survey_parameters_large = {'pupil': {'N': n,'filename': pup_filename}, \
                     ...
                     'image': {'contrast':10,'iwa':3.00,'owa':12.00,'bandwidth':0.10,'num_wavelengths':4}}


luvoir = DesignParameterSurvey(PorAPLC, survey_parameters_large, 'surveys/luvoir_baseline_N{:04d}_small_AWS/'.format(n), 'masks/')
luvoir.describe()
