...
class DesignParameterSurvey(object):
    """Class for the design parameter survey.

    Attributes
    -----------
    coronagraph_class: dict
        The Coronagraph class.
    parameter_sets: dict
        The sets of design parameters to survey.
    survey_dir: str
        The location of the base directory, where all files related to the survey will be written.
    input_files_dir: str
    ...
    def describe(self):
        """Describe the design parameter survey."""
    ...
    def write_drivers(self, overwrite=False):
        ...
        ----------
        overwrite: bool
            Whether to overwrite driver files if they already exist.
        """
        for cor in self.coronagraphs:
...
class Coronagraph(object):
    ...
    def check_input_files(self):
        """Check necessary input files exist."""
        raise NotImplementedError()

    def check_driver(self):
        """Check whether driver script exists."""
        raise NotImplementedError()

    def check_solution(self):
        """Check whether solution already exists."""
