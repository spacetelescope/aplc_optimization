parameters = {'pupil': {'pup_type': 'HiCAT', 'filename': 'masks/HiCAT/hicat_apodizer_mask_972_gy.fits', 'N': 972}, 'focal_plane_mask': {'radius': 4.2715, 'num_pix': 80, 'grayscale': True, 'field_stop_radius': -1.0}, 'lyot_stop': {'filename': 'masks/HiCAT/hicat_lyot_mask_972_gy_0.fits', 'alignment_tolerance': 2, 'num_lyot_stops': 9}, 'image': {'contrast': 8, 'iwa': 3.75, 'owa': 15.0, 'num_wavelengths': 4, 'bandwidth': 0.1, 'resolution': 2.5}, 'method': {'force_no_x_mirror_symmetry': False, 'force_no_y_mirror_symmetry': False, 'force_no_hermitian_symmetry': False, 'starting_scale': 1, 'ending_scale': 1, 'edge_width_for_prior': 2, 'num_throughput_iterations': 2, 'initial_throughput_estimate': 0.30250000000000005, 'maximize_planet_throughput': True}, 'solver': {'num_threads': 0, 'crossover': 0, 'method': 2}}
file_organization = {'survey_dir': '/user/kstlaurent/git/progressive_refinement_coronagraphy/surveys/hicat_test', 'solution_dir': '/user/kstlaurent/git/progressive_refinement_coronagraphy/surveys/hicat_test/solutions', 'analysis_dir': '/user/kstlaurent/git/progressive_refinement_coronagraphy/surveys/hicat_test/analysis', 'drivers_dir': '/user/kstlaurent/git/progressive_refinement_coronagraphy/surveys/hicat_test/drivers', 'log_dir': '/user/kstlaurent/git/progressive_refinement_coronagraphy/surveys/hicat_test/logs', 'input_files_dir': '/user/kstlaurent/git/progressive_refinement_coronagraphy/masks'}
solution_fname = "/user/kstlaurent/git/progressive_refinement_coronagraphy/surveys/hicat_test/solutions/HICAT_test_972_robust.fits"
