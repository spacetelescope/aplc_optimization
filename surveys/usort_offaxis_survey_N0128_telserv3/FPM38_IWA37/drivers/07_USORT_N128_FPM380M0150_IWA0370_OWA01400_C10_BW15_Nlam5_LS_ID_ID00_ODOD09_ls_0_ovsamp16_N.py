parameters = {'instrument': {'inst_name': 'USORT'}, 'pupil': {'filename': 'USORT/TelAp_USORT_offaxis_ovsamp16_N0128.fits', 'N': 128}, 'focal_plane_mask': {'radius': 3.8000000000000003, 'num_pix': 150, 'grayscale': True, 'field_stop_radius': None}, 'lyot_stop': {'filename': 'USORT/LS_USORT_hex_ID0000_OD0990_ovsamp16_N0128.fits', 'alignment_tolerance': 0, 'num_lyot_stops': 1}, 'image': {'contrast': 10, 'iwa': 3.7, 'owa': 14.0, 'num_wavelengths': 5, 'bandwidth': 0.15, 'resolution': 2}, 'method': {'force_no_x_mirror_symmetry': False, 'force_no_y_mirror_symmetry': False, 'force_no_hermitian_symmetry': False, 'starting_scale': 1, 'ending_scale': 1, 'edge_width_for_prior': 2, 'num_throughput_iterations': 2, 'initial_throughput_estimate': 1, 'maximize_planet_throughput': True}, 'solver': {'num_threads': 0, 'crossover': 0, 'method': 2}}
...
solution_fname = "/user/bnickson/GitHub/LUVex_TelAps/aplc_optimization/surveys/usort_offaxis_survey_N0128_telserv3/FPM38_IWA37/solutions/07_USORT_N128_FPM380M0150_IWA0370_OWA01400_C10_BW15_Nlam5_LS_ID_ID00_ODOD09_ls_0_ovsamp16_N.fits"
