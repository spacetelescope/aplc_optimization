parameters = {'pupil': {'filename': 'LUVOIR/TelAp_LUVOIR_gap_pad02_bw_ovsamp03_N0500.fits', 'N': 500}, 'focal_plane_mask': {'radius': 12.14, 'num_pix': 50, 'grayscale': True, 'field_stop_radius': -1.0}, 'lyot_stop': {'filename': 'LUVOIR/LS_LUVOIR_ID0190_OD0937_no_struts_gy_ovsamp3_N0500.fits', 'alignment_tolerance': 0, 'num_lyot_stops': 1}, 'image': {'contrast': 10, 'iwa': 12.04, 'owa': 38.53, 'num_wavelengths': 4, 'bandwidth': 0.1, 'resolution': 2}, 'method': {'force_no_x_mirror_symmetry': False, 'force_no_y_mirror_symmetry': False, 'force_no_hermitian_symmetry': False, 'starting_scale': 1, 'ending_scale': 1, 'edge_width_for_prior': 2, 'num_throughput_iterations': 2, 'initial_throughput_estimate': 1, 'maximize_planet_throughput': True}, 'solver': {'num_threads': 0, 'crossover': 0, 'method': 2}}
file_organization = {'survey_dir': '/user/kstlaurent/git/progressive_refinement_coronagraphy/surveys/luvoir_baseline_N0500_large_telserv3', 'solution_dir': '/user/kstlaurent/git/progressive_refinement_coronagraphy/surveys/luvoir_baseline_N0500_large_telserv3/solutions', 'analysis_dir': '/user/kstlaurent/git/progressive_refinement_coronagraphy/surveys/luvoir_baseline_N0500_large_telserv3/analysis', 'drivers_dir': '/user/kstlaurent/git/progressive_refinement_coronagraphy/surveys/luvoir_baseline_N0500_large_telserv3/drivers', 'log_dir': '/user/kstlaurent/git/progressive_refinement_coronagraphy/surveys/luvoir_baseline_N0500_large_telserv3/logs', 'input_files_dir': '/user/kstlaurent/git/progressive_refinement_coronagraphy/masks'}
solution_fname = "/user/kstlaurent/git/progressive_refinement_coronagraphy/surveys/luvoir_baseline_N0500_large_telserv3/solutions/0_LUVOIR_N500_FPM1214M050_IWA1204_OWA03853_C10_BW10_Nlam4_LS_IDD0190_OD0937_no_ls_struts.fits"
