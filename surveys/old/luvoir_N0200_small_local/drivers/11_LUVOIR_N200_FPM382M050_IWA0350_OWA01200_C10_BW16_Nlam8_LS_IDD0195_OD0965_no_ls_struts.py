parameters = {'pupil': {'filename': 'LUVOIR/TelAp_LUVOIR_gap_pad04_bw_ovsamp04_N0200.fits', 'N': 200}, 'focal_plane_mask': {'radius': 3.82, 'num_pix': 50, 'grayscale': True, 'field_stop_radius': -1.0}, 'lyot_stop': {'filename': 'LUVOIR/LS_LUVOIR_ID0195_OD0965_no_struts_gy_ovsamp4_N0200.fits', 'alignment_tolerance': 0, 'num_lyot_stops': 1}, 'image': {'contrast': 10, 'iwa': 3.5, 'owa': 12.0, 'num_wavelengths': 8, 'bandwidth': 0.16, 'resolution': 2}, 'method': {'force_no_x_mirror_symmetry': False, 'force_no_y_mirror_symmetry': False, 'force_no_hermitian_symmetry': False, 'starting_scale': 1, 'ending_scale': 1, 'edge_width_for_prior': 2, 'num_throughput_iterations': 2, 'initial_throughput_estimate': 1, 'maximize_planet_throughput': True}, 'solver': {'num_threads': 0, 'crossover': 0, 'method': 2}}
...
solution_fname = "/user/kstlaurent/git/progressive_refinement_coronagraphy/surveys/luvoir_N0200_small_local/solutions/11_LUVOIR_N200_FPM382M050_IWA0350_OWA01200_C10_BW16_Nlam8_LS_IDD0195_OD0965_no_ls_struts.fits"
