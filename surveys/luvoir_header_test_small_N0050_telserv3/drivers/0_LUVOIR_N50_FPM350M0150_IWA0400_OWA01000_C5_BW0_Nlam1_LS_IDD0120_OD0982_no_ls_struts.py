parameters = {'pupil': {'filename': 'LUVOIR/TelAp_LUVOIR_gap_pad01_bw_ovsamp04_N0050.fits', 'N': 50}, 'focal_plane_mask': {'radius': 3.5, 'num_pix': 150, 'grayscale': True, 'field_stop_radius': -1.0}, 'lyot_stop': {'filename': 'LUVOIR/LS_LUVOIR_ID0120_OD0982_no_struts_gy_ovsamp4_N0050.fits', 'alignment_tolerance': 0, 'num_lyot_stops': 1}, 'image': {'contrast': 5, 'iwa': 4, 'owa': 10.0, 'num_wavelengths': 1, 'bandwidth': 0, 'resolution': 2}, 'method': {'force_no_x_mirror_symmetry': False, 'force_no_y_mirror_symmetry': False, 'force_no_hermitian_symmetry': False, 'starting_scale': 1, 'ending_scale': 1, 'edge_width_for_prior': 2, 'num_throughput_iterations': 2, 'initial_throughput_estimate': 1, 'maximize_planet_throughput': True}, 'solver': {'num_threads': 0, 'crossover': 0, 'method': 2}}
file_organization = {'survey_dir': '/user/kstlaurent/git/progressive_refinement_coronagraphy/surveys/luvoir_header_test_small_N0050_telserv3', 'solution_dir': '/user/kstlaurent/git/progressive_refinement_coronagraphy/surveys/luvoir_header_test_small_N0050_telserv3/solutions', 'analysis_dir': '/user/kstlaurent/git/progressive_refinement_coronagraphy/surveys/luvoir_header_test_small_N0050_telserv3/analysis', 'drivers_dir': '/user/kstlaurent/git/progressive_refinement_coronagraphy/surveys/luvoir_header_test_small_N0050_telserv3/drivers', 'log_dir': '/user/kstlaurent/git/progressive_refinement_coronagraphy/surveys/luvoir_header_test_small_N0050_telserv3/logs', 'input_files_dir': '/user/kstlaurent/git/progressive_refinement_coronagraphy/masks'}
solution_fname = "/user/kstlaurent/git/progressive_refinement_coronagraphy/surveys/luvoir_header_test_small_N0050_telserv3/solutions/0_LUVOIR_N50_FPM350M0150_IWA0400_OWA01000_C5_BW0_Nlam1_LS_IDD0120_OD0982_no_ls_struts.fits"
...
hdr.set('PUP',parameters['pupil']['filename'])
hdr.set('FPM_RAD',fpm_radius,'lam/d')
hdr.set('FPM_PIX',fpm_num_pix)
hdr.set('FPM_GY',fpm_grayscale)
hdr.set('LS',parameters['lyot_stop']['filename'])
hdr.set('LS_ALIGN_TOl',ls_alignment_tolerance)
hdr.set('LS_NUM_STOPS',ls_num_stops)
hdr.set('CONTRAST',img_contrast)
hdr.set('IWA',img_iwa)
hdr.set('OWA',img_owa)
hdr.set('NLAM',img_num_wavelengths)
hdr.set('BW',img_bandwidth)
hdr.set('IMG_RES',img_resolution)
hdr.set('PROG_START',method_starting_scale)
hdr.set('PROG_END',method_ending_scale)
hdr.set('PROG_EDGE',method_edge_width_for_prior)
hdr.set('THRPT_ITER',method_num_throughput_iterations)
hdr.set('THRPT_ESTIM',method_initial_throughput_estimate)
hdr.set('MAX_THRPT',method_maximize_planet_throughput)
hdr.set('SLV_THRDS',solver_num_threads)
hdr.set('SLV_XOVER',solver_crossover)
hdr.set('SLV_MTHD',solver_method)
