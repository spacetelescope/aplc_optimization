parameters = {'instrument': {'inst_name': 'SCDA'}, 'pupil': {'filename': 'SCDA/TelAp_SCDA_09-Hex_clipped_gy_gap_pad02_ovsamp03_N0500.fits', 'N': 500}, 'focal_plane_mask': {'radius': 3.5, 'num_pix': 150, 'grayscale': True, 'field_stop_radius': -1.0}, 'lyot_stop': {'filename': 'SCDA/LS_SCDA_ID0120_OD0982_no_struts_gy_ovsamp3_N0500.fits', 'alignment_tolerance': 0, 'num_lyot_stops': 1}, 'image': {'contrast': 10, 'iwa': 3.4, 'owa': 12.0, 'num_wavelengths': 3, 'bandwidth': 0.1, 'resolution': 2}, 'method': {'force_no_x_mirror_symmetry': False, 'force_no_y_mirror_symmetry': False, 'force_no_hermitian_symmetry': False, 'starting_scale': 1, 'ending_scale': 1, 'edge_width_for_prior': 2, 'num_throughput_iterations': 2, 'initial_throughput_estimate': 1, 'maximize_planet_throughput': True}, 'solver': {'num_threads': 0, 'crossover': 0, 'method': 2}}
...
solution_fname = "/user/bnickson/git_hub/aplc_optimization/surveys/scda_scda_segment_size_N0500_telserv3/solutions/08_SCDA_N500_FPM350M0150_IWA0340_OWA01200_C10_BW10_Nlam3_LS_ID0_OD0_OD_no__ls_truts_gy_ovs.fits"
