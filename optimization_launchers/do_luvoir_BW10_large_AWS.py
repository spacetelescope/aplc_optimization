...
survey_name = 'BW10_large'  # survey name;
machine = 'AWS'  # name of machine the survey is run on.
...
pup_filename, ls_filenames = LUVOIR_inputs_gen(input_files_dict)  # filenames of the generated input masks
...
survey_parameters = {'pupil': {'N': N, 'filename': pup_filename},
                     ...
                     'focal_plane_mask': {'radius': 13.38, 'num_pix': 400, 'grayscale': True, },
                     'image': {'contrast': 10, 'iwa': 13.28, 'owa': 46.88, 'bandwidth': 0.10, 'num_wavelengths': 5},
