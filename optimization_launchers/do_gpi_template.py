...
lyot_mask = '080m12_04' # name of Lyot mask. Available lyot masks are:
                        ...
                        #  '080m12_06_03', '080mgit 12_07', '080m12_10', 'Open' and 'Blank'.
ls_spid = True
...
# RUN DESIGN SURVEY
gpi = DesignParameterSurvey(APLC, survey_parameters, 'surveys/{}_{}_N{:04d}_{}/'.format(instrument, survey_name, nArray, machine),
                            'masks/')
gpi.describe()
