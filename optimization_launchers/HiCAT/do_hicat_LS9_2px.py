...
survey_name = 'LS9_2px'  # survey name
machine = "telserv3"  # machine the survey is run on.
N = 972  # number of pixels in input (TelAP, LS) and final (apodizer) arrays
...
resolution: 
    The image resolution in pixel / (lambda_0/D).
starting_scale: int
...
# Optimization method
maximize_planet_throughput = False  # to reflect do_apodizer_throughput_maximization=True in ../../finalized_designs/HiCAT/old/scripts/aplc_hicat_test_972.py
starting_scale = 2  # to reflect num_scalings=3 in ../../finalized_designs/HiCAT/old/scripts/aplc_hicat_test_972.py
ending_scale = 1
