...
varying_parameters = {'pupil': {'filename': 'ehpor_hicat_apodizer_mask_256_gy.fits'}, 'lyot_stop': {'filename': 'ehpor_hicat_lyot_mask_256_gy_{:d}.fits', 'num_stops': 5}, 'image': {'owa': 15}}
