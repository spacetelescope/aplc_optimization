parameters = {'pupil': {'filename': 'ehpor_apodizer_mask_256_bw.fits'}, 'focal_plane_mask': {'radius': 4.0, 'num_pix': 50, 'grayscale': True, 'field_stop_radius': -1.0}, 'lyot_stop': {'filename': 'ehpor_lyot_mask_256_gy.fits', 'alignment_tolerance': 0, 'num_lyot_stops': 1}, 'image': {'contrast': 8.0, 'iwa': 3.75, 'owa': 10, 'num_wavelengths': 3, 'bandwidth': 0.1, 'resolution': 2}, 'method': {'force_no_x_mirror_symmetry': False, 'force_no_y_mirror_symmetry': False, 'force_no_hermitian_symmetry': False, 'starting_scale': 1, 'ending_scale': 1, 'edge_width_for_prior': 2, 'num_throughput_iterations': 2, 'initial_throughput_estimate': 1, 'maximize_planet_throughput': True}, 'solver': {'num_threads': 0, 'crossover': 0, 'method': 2}}
...
solution_fname = "/data2/por/Research/Research/PhD/Coronagraphy/Optimization/progressive_refinement_coronagraphy/survey/solutions/0.fits"
